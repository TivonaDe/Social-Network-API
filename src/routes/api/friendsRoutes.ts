...
import { getAllUsers, addFriend, deleteFriend, getFriendById, getAllFriends, updateFriend } from '../../controllers/friendController'; // Adjust the import path as necessary
